...
exports.signup = async (req, res) => {
    ...
    try {
        ...
        // const hashedPassword = await bcrypt.hash(password.trim(), salt); // Trim and hash the password

        const newUser = new User({ name, email: trimmedEmail, password: password }); // Use hashed password
        await newUser.save();
